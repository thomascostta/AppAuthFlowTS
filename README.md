...
# Overview :book:
  App com fluxo de autenticação utilizando React-Native CLI com TypeScript, rotas com React Navigation v.6, gerenciamento de estado pelo Hook Context e persistência de dados com Async Storage.
